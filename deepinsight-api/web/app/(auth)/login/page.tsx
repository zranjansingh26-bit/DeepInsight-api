      ...
      >
        <div className="glass-panel p-8 rounded-2xl shadow-2xl relative z-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold gradient-text mb-2">DeepInsights</h1>
            <p className="text-slate-400">Welcome back to your AI data workspace</p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-slate-400">
            Don't have an account? <a href="/signup" className="text-indigo-400 hover:text-indigo-300 font-medium">Start your 14-day free trial</a>
          </div>
        </div>
      </motion.div>
    </div>
